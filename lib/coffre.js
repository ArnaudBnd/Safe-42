 ...
 * @return {Safe42}
 */
Safe42.prototype._initialize = function () { // lancement quand je lance le run
...
Safe42.prototype._getAction = function (key) {
  ...
  var actions = {
    'enter': function () {
      ...
      return;
    }.bind(this), // retour au context de l'appli
    'delete': function () {
...
Safe42.prototype._renderDataConsole = function (data) {
  ...
  for (var key in data) {
    dom += this._tplDataConsole(key, data[key]); // data[key] = objet storage
  }
...
var safe42 = new Safe42(storage); // constructor
